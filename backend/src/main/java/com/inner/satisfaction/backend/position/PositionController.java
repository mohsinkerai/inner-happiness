...
public class PositionController extends BaseController<Position> {
  ...
  /**
   * Returns All PositionId at given institution Id with their names It is needed when a institution
   * is selected for action
   */
  @ResponseStatus(HttpStatus.OK)
  @RequestMapping(value = "/search/findByInstitutionId", method = RequestMethod.GET)
  public PositionRecommendationResponse findByInstitutionId(
