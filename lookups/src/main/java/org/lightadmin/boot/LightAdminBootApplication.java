...
public class LightAdminBootApplication extends SpringBootServletInitializer {
   ...
   * LightAdmin.configure(servletContext) .basePackage("org.lightadmin.boot.administration")
   * .baseUrl("/admin") .security(false) .backToSiteUrl("http://lightadmin.org");
    ...
    return new ServletContextInitializer() {
      ...
      public void onStartup(ServletContext servletContext) throws ServletException {
        LightAdmin.configure(servletContext)
            ...
            .baseUrl("/admin")
            .security(false)
            .backToSiteUrl("http://localhost:8012");
