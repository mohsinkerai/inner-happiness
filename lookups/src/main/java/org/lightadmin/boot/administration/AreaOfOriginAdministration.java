...
public class AreaOfOriginAdministration extends AdministrationConfiguration<AreaOfOrigin> {

  @Override
  public EntityMetadataConfigurationUnit configuration(
      EntityMetadataConfigurationUnitBuilder configurationBuilder) {
    return configurationBuilder.nameField("name").singularName("Area Of Origin").pluralName("Areas Of Origin").build();
  }
}
